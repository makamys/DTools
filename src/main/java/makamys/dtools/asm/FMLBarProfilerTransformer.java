        ...
        try {
            ...
            for(MethodNode m : classNode.methods) {
                if(m.name.equals("push") && m.desc.equals("(Ljava/lang/String;IZ)Lcpw/mods/fml/common/ProgressManager$ProgressBar;")) {
                    ...
                    postList.add(new MethodInsnNode(INVOKESTATIC, "makamys/dtools/diagnostics/FMLBarProfiler", "instance", "()Lmakamys/dtools/diagnostics/FMLBarProfiler;", false));
                    postList.add(new InsnNode(SWAP));
                    postList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtools/diagnostics/FMLBarProfiler", "onPush", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;)V", false));    
                    ...
                    preList.add(new MethodInsnNode(INVOKESTATIC, "makamys/dtools/diagnostics/FMLBarProfiler", "instance", "()Lmakamys/dtools/diagnostics/FMLBarProfiler;", false));
                    preList.add(new VarInsnNode(ALOAD, 0));
                    preList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtools/diagnostics/FMLBarProfiler", "onPop", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;)V", false));    
        ...
        try {
            ...
            for(MethodNode m : classNode.methods) {
                if(m.name.equals("step") && m.desc.equals("(Ljava/lang/String;)V")) {
                    ...
                    postList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtools/diagnostics/FMLBarProfiler", "onStep", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;Z)V", false));    
