...
import makamys.dtools.diagnostics.MethodProfiler.MethodInstrumentationData;
		...
		try {
			...
			for(MethodNode m : classNode.methods) {
				...
				if(classTargets.contains(methodName)) {
					...
					m.instructions.insert(new MethodInsnNode(INVOKESTATIC, "makamys/dtools/diagnostics/MethodProfiler", "preTargetCalled", "(I)V", false));
