package makamys.dtools.tweak.crashhandler;
...
public class Crasher implements IModEventListener {
    ...
    private static final boolean CRASH_EVERY_CLIENT_TICK = Boolean.parseBoolean(System.getProperty("dtools.crasher.crashEveryClientTick", "false"));
