        ...
        try {
            ...
            for(MethodNode m : classNode.methods) {
                if(m.name.equals("push") && m.desc.equals("(Ljava/lang/String;IZ)Lcpw/mods/fml/common/ProgressManager$ProgressBar;")) {
                    ...
                    postList.add(new MethodInsnNode(INVOKESTATIC, "makamys/dtails/diagnostics/FMLBarProfiler", "instance", "()Lmakamys/dtails/diagnostics/FMLBarProfiler;", false));
                    postList.add(new InsnNode(SWAP));
                    postList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtails/diagnostics/FMLBarProfiler", "onPush", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;)V", false));    
                    ...
                    preList.add(new MethodInsnNode(INVOKESTATIC, "makamys/dtails/diagnostics/FMLBarProfiler", "instance", "()Lmakamys/dtails/diagnostics/FMLBarProfiler;", false));
                    preList.add(new VarInsnNode(ALOAD, 0));
                    preList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtails/diagnostics/FMLBarProfiler", "onPop", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;)V", false));    
        ...
        try {
            ...
            for(MethodNode m : classNode.methods) {
                if(m.name.equals("step") && m.desc.equals("(Ljava/lang/String;)V")) {
                    ...
                    postList.add(new MethodInsnNode(INVOKEVIRTUAL, "makamys/dtails/diagnostics/FMLBarProfiler", "onStep", "(Lcpw/mods/fml/common/ProgressManager$ProgressBar;Z)V", false));    
