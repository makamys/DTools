package makamys.dtails.tweak.crashhandler;
...
public class Crasher implements IModEventListener {
    ...
    private static final boolean CRASH_EVERY_CLIENT_TICK = Boolean.parseBoolean(System.getProperty("dtails.crasher.crashEveryClientTick", "false"));
